...
donde tener ascensor encarece el metro cuadrado en 2.287 € y 1.834 € respectivamente.
Arganzuela y Vicálvaro presentan las menores diferencias de toda la lista, 
con apenas 338 € y 344 € por metro cuadrado de diferencia respectivamente.*/
...
ORDER BY
    diff DESC;
/* Para pisos de dos habitaciones, la diferencia es de 3068€, lo que sugiere que el ascensor se valora más según el tamaño de la vivienda. 
En los pisos de una sola habitación, la diferencia se reduce a 1473€. 
Además, el precio medio de un piso de 1 habitación sin ascensor (4994€) 
es incluso más alto que el de 2 habitaciones sin ascensor (4636€) */
...
ya que requieren invertir solo entre 5.3 y 5.5 años de renta íntegra para comprar una vivienda.
Vicálvaro y Carabanchel son las zonas menos asequibles, con ratios extremos de 78.68 y 71.01, 
